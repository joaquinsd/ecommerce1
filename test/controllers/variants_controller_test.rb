...
class VariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variant" do
    assert_difference('Variant.count') do
      post variants_url, params: { variant: { color_id: @variant.color_id, size_id: @variant.size_id, stock: @variant.stock } }
    end
  ...
  test "should update variant" do
    patch variant_url(@variant), params: { variant: { color_id: @variant.color_id, size_id: @variant.size_id, stock: @variant.stock } }
